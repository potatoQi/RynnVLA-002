...
export DATA_CONFIG_TRAIN=${DATA_CONFIG_TRAIN:-../configs/bair_robot_pushing/his_1_world_model_pretokenize_train.yaml}
export DATA_CONFIG_VAL_IND=${DATA_CONFIG_VAL_IND:-../configs/bair_robot_pushing/his_1_world_model_pretokenize_test.yaml}
export DATA_CONFIG_VAL_OOD=${DATA_CONFIG_VAL_OOD:-../configs/bair_robot_pushing/his_1_world_model_pretokenize_test.yaml}
...
export EXP_NAME=${EXP_NAME:-bair_world_model_from_official_awm_pretokenize}
